...
## Compelete - Maximum distance between groups - Tends to produce a more balanced tree
## Single - Minimum distance between groups - Tends to produce more unbalanced trees
## Mean - Average distance between groups - Tends to produce a more balanced tree
